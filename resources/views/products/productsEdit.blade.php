...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="justify-content-center">Edit Product - {{$product->product_name}}</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid containCust">
                    <div class="card ">
                        <form class="form-horizontal" method="POST"
                            action="{{route('products.update',$product->product_id)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="btn-group btn-group-toggle btn-toolbar d-flex flex-warp {{ $errors->has('category') ? 'is-invalid' : '' }}"
                                            data-toggle="buttons">
                                            <div
                                                class="btn btn-md btn-outline-primary {{($product->category == '0') ? 'active' : ''}}">
                                                <input {{($product->category == '0') ? 'checked' : ''}} type="radio"
                                                    name="category" id="rims" value="0" autocomplete="off"
                                                    onchange="toggleCategory(this)" required>Rims
                                            </div>
                                            <div
                                                class="btn btn-md btn-outline-primary  {{($product->category == '1') ? 'active' : ''}}">
                                                <input {{($product->category == '1') ? 'checked' : ''}} type="radio"
                                ...
                                <div class="form-group row" id="rim_type_toggle">
                                    ...
                                    <div class="col-md-5">
                                        <div class="btn-group btn-toolbar d-flex flex-warp btn-group-toggle {{ $errors->has('rim_type') ? 'is-invalid' : '' }}"
                                            ...
                                            <div
                                                class="btn btn-md btn-outline-primary {{($product->rim_type == '') ? 'active' : ''}} {{($product->rim_type == '0') ? 'active' : ''}}">
                                                <input {{($product->rim_type == '') ? 'checked' : ''}}
                                                    {{($product->rim_type == '0') ? 'checked' : ''}} type="radio"
                                                    name="rim_type" value="0" id="replica" autocomplete="off"
                                                    required>Replica
                                            </div>
                                            <div
                                                class="btn btn-md btn-outline-primary {{($product->rim_type == '1') ? 'active' : ''}}">
                                                <input {{($product->rim_type == '1') ? 'checked' : ''}} type="radio"
                                                    name="rim_type" value="1" id="original" autocomplete="off">Original
                                            </div>
                                            <div
                                                class="btn btn-md btn-outline-primary {{($product->rim_type == '2') ? 'active' : ''}}">
                                                <input {{($product->rim_type == '2') ? 'checked' : ''}} type="radio"
                                    ...
                                    <div class="col-md-2" id="unit">
                                        <div class="">
                                            <select class="custom-select {{ $errors->has('unit') ? 'is-invalid' : '' }}"
                                                name="unit" required>
                                                <option value="" {{($product->unit == '') ? 'selected' : ''}} disabled>
                                                    Unit
                                                </option>
                                                <option value="0" {{($product->unit == '0') ? 'selected' : ''}}>
                                                    Piece(s)</option>
                                                <option value="1" {{($product->unit == '1') ? 'selected' : ''}}>Set
                                                </option>
                                            </select>
                                        </div>
                                        @if ($errors->has('unit'))
                                ...
                                <div class="form-group row" id="rim_diameter_toggle">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <input value="{{$product->rim_diameter}}" type="text" name="rim_diameter"
                                                id="rim_diameter"
                                ...
                                <div class="form-group row" id="front_rim_width_toggle">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <input value="{{$product->front_rim_width}}" type="text"
                                                name="front_rim_width" id="front_rim_width"
                                ...
                                <div class="form-group row" id="rear_rim_width_toggle">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <input value="{{$product->rear_rim_width}}" type="text"
                                                name="rear_rim_width" id="rear_rim_width"
                                ...
                                <div class="form-group row" id="front_offset_toggle">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            ...
                                            <input value="{{$product->front_offset}}" type="text" name="front_offset"
                                                id="front_offset"
                                ...
                                <div class="form-group row" id="rear_offset_toggle">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            ...
                                            <input value="{{$product->rear_offset}}" type="text" name="rear_offset"
                                                id="rear_offset"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="btn-group btn-group-toggle btn-toolbar d-flex flex-warp {{ $errors->has('pcd_control') ? 'is-invalid' : '' }}"
                                                data-toggle="buttons">
                                                <div
                                                    class="btn btn-md btn-outline-primary  {{($product->pcd_control == '') ? 'active' : ''}} {{($product->pcd_control == 'yes') ? 'active' : ''}}">
                                                    <input {{($product->pcd_control == '') ? 'checked' : ''}}
                                                        {{($product->pcd_control == 'yes') ? 'checked' : ''}}
                                                        type="radio" name="pcd_control" id="yes" value="yes"
                                                        autocomplete="off" onchange="togglePCD(this)" required>Yes
                                                </div>
                                                <div
                                                    class="btn btn-md btn-outline-primary  {{($product->pcd_control == 'no') ? 'active' : ''}}">
                                                    <input {{($product->pcd_control == 'no') ? 'checked' : ''}}
                                        ...
                                        <div class="col-md-5 ">
                                            <div class="">
                                                <select
                                                    ...
                                                    <option value="" {{($product->pcd_1 == '') ? 'selected' : ''}}
                                                        disabled>
                                                        Choose One
                                                    </option>
                                                    <option value="0" {{($product->pcd_1 == '0') ? 'selected' : ''}}>
                                                        4 x 100 mm</option>
                                                    <option value="1" {{($product->pcd_1 == '1') ? 'selected' : ''}}>
                                                        4 x 108 mm</option>
                                                    <option value="2" {{($product->pcd_1 == '2') ? 'selected' : ''}}>
                                                        4 x 114,3 mm</option>
                                                    <option value="3" {{($product->pcd_1 == '3') ? 'selected' : ''}}>
                                                        5 x 100 mm</option>
                                                    <option value="4" {{($product->pcd_1 == '4') ? 'selected' : ''}}>
                                                        5 x 108 mm</option>
                                                    <option value="5" {{($product->pcd_1 == '5') ? 'selected' : ''}}>
                                                        5 x 112 mm</option>
                                                    <option value="6" {{($product->pcd_1 == '6') ? 'selected' : ''}}>
                                                        5 x 114,3 mm</option>
                                                    <option value="7" {{($product->pcd_1 == '7') ? 'selected' : ''}}>
                                                        5 x 120 mm</option>
                                                    <option value="8" {{($product->pcd_1 == '8') ? 'selected' : ''}}>
                                                        5 x 127 mm</option>
                                                    <option value="9" {{($product->pcd_1 == '9') ? 'selected' : ''}}>
                                                        5 x 130 mm</option>
                                                    <option value="10" {{($product->pcd_1 == '10') ? 'selected' : ''}}>
                                                        5 x 139,7 mm</option>
                                                    <option value="11" {{($product->pcd_1 == '11') ? 'selected' : ''}}>
                                                        5 x 165,1 mm</option>
                                                    <option value="12" {{($product->pcd_1 == '12') ? 'selected' : ''}}>
                                                        6 x 114,3 mm</option>
                                                    <option value="13" {{($product->pcd_1 == '13') ? 'selected' : ''}}>
                                                        6 x 139,7 mm</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5 ">
                                            <div class="">
                                                <select
                                                    ...
                                                    <option value="" {{($product->pcd_2 == '') ? 'selected' : ''}}
                                                        disabled>
                                                        Choose One
                                                    </option>
                                                    <option value="0" {{($product->pcd_2 == '0') ? 'selected' : ''}}>
                                                        4 x 100 mm</option>
                                                    <option value="1" {{($product->pcd_2 == '1') ? 'selected' : ''}}>
                                                        4 x 108 mm</option>
                                                    <option value="2" {{($product->pcd_2 == '2') ? 'selected' : ''}}>
                                                        4 x 114,3 mm</option>
                                                    <option value="3" {{($product->pcd_2 == '3') ? 'selected' : ''}}>
                                                        5 x 100 mm</option>
                                                    <option value="4" {{($product->pcd_2 == '4') ? 'selected' : ''}}>
                                                        5 x 108 mm</option>
                                                    <option value="5" {{($product->pcd_2 == '5') ? 'selected' : ''}}>
                                                        5 x 112 mm</option>
                                                    <option value="6" {{($product->pcd_2 == '6') ? 'selected' : ''}}>
                                                        5 x 114,3 mm</option>
                                                    <option value="7" {{($product->pcd_2 == '7') ? 'selected' : ''}}>
                                                        5 x 120 mm</option>
                                                    <option value="8" {{($product->pcd_2 == '8') ? 'selected' : ''}}>
                                                        5 x 127 mm</option>
                                                    <option value="9" {{($product->pcd_2 == '9') ? 'selected' : ''}}>
                                                        5 x 130 mm</option>
                                                    <option value="10" {{($product->pcd_2 == '10') ? 'selected' : ''}}>
                                                        5 x 139,7 mm</option>
                                                    <option value="11" {{($product->pcd_2 == '11') ? 'selected' : ''}}>
                                                        5 x 165,1 mm</option>
                                                    <option value="12" {{($product->pcd_2 == '12') ? 'selected' : ''}}>
                                                        6 x 114,3 mm</option>
                                                    <option value="13" {{($product->pcd_2 == '13') ? 'selected' : ''}}>
                                                        6 x 139,7 mm</option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row" id="tire_diameter_toggle" hidden=true>
                                    <label for="tire_diameter" class="col-md-3 control-label">Wheel Diameter<strong
                                            class="required_red">*</strong></label>
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <input value="{{$product->tire_diameter}}" type="text" name="tire_diameter"
                                                id="tire_diameter"
                                ...
                                <div class="form-group row" id="tire_width_toggle" hidden=true>
                                    <label for="tire_width" class="col-md-3 control-label">Wheel Width<strong
                                            class="required_red">*</strong></label>
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <input value="{{$product->tire_width}}" type="text" name="tire_width"
                                                id="tire_width"
                                ...
                                <div class="form-group row" id="tire_width_ratio_toggle" hidden=true>
                                    <label for="tire_width_ratio" class="col-md-3 control-label">Wheel Thickness Ratio
                                        <strong class="required_red">*</strong></label>
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <input value="{{$product->tire_width_ratio}}" type="text"
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <button type="submit" class="btn btn-lg btn-primary m-1">Submit</button>
                                <a href="" class="btn btn-lg btn-default m-1">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        $(window).on('load',combinedToggleFunctions);
        function combinedToggleFunctions(){
            toggleCategory();
            tooglePCD();
        };
